...
- Public preview: `https://ec92009.github.io/WebByElie/?v=143.8`
...
- Current version is `143.8`, displayed as `v143.8`.
...
1. Monitor search indexing pickup.
   Recheck Google coverage for `/fr/` and `/es/`, Bing sitemap processing, and Bing's homepage logo-alt notice after `v143.8` has deployed and crawlers have processed the requests.
