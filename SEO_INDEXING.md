...
Bing flagged one homepage SEO/GEO notice for the logo image alt text. The visible brand mark now has a meaningful `alt`, and that fix remains present in `v143.4`.
...
- Re-run Bing URL Inspection for the homepage after `v143.4` is deployed and crawled to confirm the logo alt notice clears.
